...
final class BuiltInRules
{
    ...
    public const MAP = [
        ...
        'type-declarations' => TypeDeclarationsRule::class,
        'no-service-location' => NoServiceLocationRule::class,
        'str-contains' => StrContainsRule::class,
        'first-class-callable-syntax' => FirstClassCallableSyntaxRule::class,
        'array-spread-operator' => ArraySpreadOperatorRule::class,
        'typed-class-constants' => TypedClassConstantsRule::class,
        'match-expression' => MatchExpressionRule::class,
        'never-return-type' => NeverReturnTypeRule::class,
        'readonly-classes' => ReadonlyClassesRule::class,
        'numeric-literal-separator' => NumericLiteralSeparatorRule::class,
    ];
