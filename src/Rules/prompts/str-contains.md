---
name: fix-compass-str-contains
description: Replace strpos() comparisons with str_contains / str_starts_with. Use when Compass reports a `str-contains` violation.
rule: str-contains
...
Expect zero `str-contains` rows for `<file>` and a green test suite.
